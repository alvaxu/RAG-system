...
![](images/2de34f2493cb364cfc8c8155df0d4013349b6898ee534152a933463eb071a36f.jpg)
...
![](images/dab35542ea891959ad3d9e8334c1251be46fec891177b0d51a2aa56221ac420e.jpg)
...
1 rl "messages": [ { "content": "<image>Who are they?", "role": "user" }, { "content": "They're Kane and Gretzka from Bayern Munich.", "role": "assistant" }, { "content": "What are they doing?<image>", "role": "user" },
...
注意力探测（与线性池化类似，但额外训练注意力池化层）识别结果(Top-1Accuracy)
...
![](images/70e9d6bc61d352efbf2408398c07eb8fa5e35c3b8de5d5de0ac13efb5bb9f897.jpg)
...
》风险提示：技术迭代不及预期、国内AIAgent商业化进展不及预期、算力供应不及预期、行业竟争加剧风险等。
...
话说天下大势，分久必合，合久必分。周末七国分争，并入于秦。及秦灭之后 楚、汉分争，又并入于汉。汉朝自高祖斩白蛇而起义，一统天下，后来光武中 兴,传至献帝，遂分为三国。推其致乱之由，殆始于桓、灵二帝。桓帝禁锢善 类,崇信宦官。及桓帝崩，灵帝即位，大将军窦武、太傅陈蕃共相辅佐。时有 宦官曹节等弄权，窦武、陈蕃谋诛之，机事不密，反为所害，中涓自此愈横。
...
核心逻辑 证券 AAgent大模型开理时刻算力低推动产业化进程。A立gen夫策和行动作的 调用工具去逐步完成给定目标的能力，可拆解为大模型+规划+记忆+工定目标的能力，可拆解为大模型+规划+记忆+工具使用四个烟读部分，我们认为，ALAg的产业发展离不月AI大模型的进步和维理成本的下降，血前已 创模型 ，模型性能不再仅仅受 预训断防投，现在 具使用四个组成部分。我们认为，AlAgent的产业发展离不开AI大模型的进用力去年缩水70%，接票 去年由于A算力供应意张，H100的用预价格高送每小时8美元，但现在市场上算力洪应过响，价格择到了每小时2美元以下。 步和推理成本的下降，当前已初步具备发展条件。1)o1掀起推理的划时代革得显著进屏，大楼型能力增长遇电隙，国内外科技大厂转向ALAgert，国外来看，OpenAL国内来香 AutoGLM,百度 、钉叮等互联网大厂份纷理进，我们认为，随着 经程不断温量，都分企业已 命，通过思维链开启推理ScallingLaw时刻。根据TheInformation,传统的大积累了大量的数字文 AXONE 资料等，具备行业know-hom的 ]AL+数图分析：Palantir，A速政资合 业更有能力推出Agen应用，美国直领或龙头不断管地ALAgenL，1）Al+营销：AppLovin ：3)AI+CRM:Salesforce, 起到望美员工效率和员工 模型ScalingLaw已经撞墙，OpenAl发布了全新的多模态Self-playRL模型nt重整各个部门的业务流程，扩大员工工作效规；5）耗+数育： 行业应材施款 o1,o1开创模型scaling的新维度，模型性能不再仅仅受限于预训练阶段，现在带来企业价值，楼据甲子光年，至2030年 □，至早 可以通过增加推理计算资源来提升模型表现。2)国内外算力供需错配现象在行业锁划 ow-how，深入了解客户置求 夕，如果长期 程助企业提升的产能大于投入的成率，抗有望形或付费，从而实现 价值免现，近期两外A应用业适大理发，担步验证重类AAgenf的商业价值，资本市场表现亮期，Applovin，Palantr，Innodata 2024年转至11月26日股价潮碳分别为750.36%，296.50%，418.23%， 改善，算力部署成本有望下降，有利于Agent产业化推广。从AI算力租赁成本1 ) toB Ag 大模型日着推理筑不要选代，AIA 网络、致选互取 用，告产，，究 汉得信息、用友网、科大氏飞 华影视、中国欧件国 来看，租赁价格今年较去年缩水 $7 0 \%$ 。根据PANews，去年由于AI算力供应置石网络、汉仅股份、美图公司、丢从科技等。 紧张，H100的租赁价格高达每小时8美元，但现在市场上算力供应过剩，价格标：技术选代不及预网、国内AIAgen南业化进属不及预期、算力供应不及预属、行业育争如刷风脸等。 降到了每小时2美元以下。证目录 产业进程：国内外科技厂商共振，美国涌现多款垂类AIAgent取得显著进展。CONTENTS 大模型能力增长遇瓶颈,国内外科技大厂转向AIAgent。国外来看,OpenAl、Google、Anthropic正在将注意力从模型转移至一系列Al01 算力t底异业 Agent工具上,Anthropic推出Computeruse,变革人类与PC交互方式,OpenAl、Google也将Agent应用排上日程;国内来看，智谱抢跑发布02 产业程：国内外科技厂商共振， AutoGLM,百度、腾讯、钉钉等互联网大厂纷纷跟进。我们认为，随着企业数字化进程不断发展,部分企业已积累了大量的数字文档、资料等，具备行业03 商业式g用性增疆 know-how的企业更有能力推出Agent应用,美国垂直领域龙头不断落地Al04 投资建设和 At $\mathsf { A l + }$ 数据分起到提高员工效率和员工人数的作用;4)AI+办公：微软连出10款AI Agent,涵盖销售、运营、服务三类.内部Copilot和Aaent重塑各个部门的业务流程.
