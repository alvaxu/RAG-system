...
class AnswerWithRAGContextSharedPrompt:
    instruction = """
所有问题涉及的公司名称/company name都是"AI应用开发"
...
class AnswerWithRAGContextNamePrompt:
    ...
    class AnswerSchema(BaseModel):
        ...
        relevant_pages: List[dict] = Field(description="""
每个元素包含 file_name 和 page，例如：[{file_name: 'xxx.pdf', page: 5}]。只包含直接用于回答问题的信息页面。
- file_name: 该内容来源的文件名
- page: 页码
只包括：
- 直接包含答案或明确陈述的页面
...
```
{
  ...
  "relevant_pages": [{"file_name": "南方航空2023年报.pdf", "page": 58}],
  "final_answer": "张三"
}
```
"""
...
```
{
  ...
  "relevant_pages": [{"file_name": "万科2022年报.pdf", "page": 78}],
...
```
{
  ...
  "relevant_pages": [{"file_name": "万科2022年报.pdf", "page": 12}, {"file_name": "万科2022年报.pdf", "page": 18}, {"file_name": "万科2022年报.pdf", "page": 45}],
  "final_answer": false
}
```
"""
...
```
{
    ...
    "relevant_pages": [{"file_name": "万科2022年报.pdf", "page": 89}],
    "final_answer": ["张三", "李四"]
}
```
"""
...
```
{
  ...
  "relevant_pages": [{"file_name": "万科2022年报.pdf", "page": 10}, {"file_name": "万科2022年报.pdf", "page": 11}, {"file_name": "万科2022年报.pdf", "page": 12}],
