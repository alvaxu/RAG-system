...
# 创建输出目录
os.makedirs('3.2.4_prophet_output', exist_ok=True)
os.makedirs('3.2.4_feature_output', exist_ok=True)
...
purchase_df.to_csv('3.2.4_feature_output/3.2.4_prophet_purchase.csv', index=False, encoding='utf-8-sig')
redeem_df.to_csv('3.2.4_feature_output/3.2.4_prophet_redeem.csv', index=False, encoding='utf-8-sig')
...
holiday_df.to_csv('3.2.4_feature_output/3.2.4_prophet_holidays.csv', index=False, encoding='utf-8-sig')
...
daily.to_csv('3.2.4_feature_output/3.2.4_prophet_daily_features.csv', index=False, encoding='utf-8-sig')
...
purchase_df = pd.read_csv('3.2.4_feature_output/3.2.4_prophet_purchase.csv', parse_dates=['ds'])
redeem_df = pd.read_csv('3.2.4_feature_output/3.2.4_prophet_redeem.csv', parse_dates=['ds'])
holidays = pd.read_csv('3.2.4_feature_output/3.2.4_prophet_holidays.csv', parse_dates=['ds'])
...
plt.savefig('3.2.4_prophet_output/3.2.4_prophet_purchase_redeem_compare.png')
plt.close()

# 10. 分解图
fig = purchase_model.plot_components(purchase_forecast)
plt.savefig('3.2.4_prophet_output/3.2.4_prophet_purchase_components.png')
plt.close()
fig = redeem_model.plot_components(redeem_forecast)
plt.savefig('3.2.4_prophet_output/3.2.4_prophet_redeem_components.png')
plt.close()
...
plt.savefig('3.2.4_prophet_output/3.2.4_prophet_purchase_residuals.png')
plt.close()
# 赎回残差
...
plt.axhline(0, color='red', linestyle='--')
plt.savefig('3.2.4_prophet_output/3.2.4_prophet_redeem_residuals.png')
plt.close()
...
predict_df.to_csv('3.2.4_prophet_output/3.2.4_prophet_predict.csv', index=False, header=False, encoding='utf-8-sig')

print('Prophet建议参数建模、分解图与残差分析已完成，结果保存在3.2.4_prophet_output目录。') 