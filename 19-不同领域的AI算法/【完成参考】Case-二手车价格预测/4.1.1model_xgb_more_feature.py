...
def main():
    ...
    # 4. 保存模型
    joblib.dump(xgb, 'xgb_model_final_4000.joblib')
    print('模型已保存到 xgb_model_final_4000.joblib')
    ...
    result.to_csv('used_car_sample_submit_xgb_final_4000.csv', index=False)
    print('预测结果已保存到 used_car_sample_submit_xgb_final_4000.csv')
