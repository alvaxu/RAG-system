...
class Settings:
    ...
    def load_from_file(cls, file_path: str) -> 'Settings':
        ...
        if 'api' in config_dict:
            ...
            settings.dashscope_api_key = api_config.get('dashscope_api_key', settings.dashscope_api_key)
            settings.mineru_api_key = api_config.get('mineru_api_key', settings.mineru_api_key)
