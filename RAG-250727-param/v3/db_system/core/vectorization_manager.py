...
# 导入向量化器
from db_system.vectorization.text_vectorizer import LangChainTextVectorizer as TextVectorizer
from db_system.vectorization.image_vectorizer import ImageVectorizer
from db_system.vectorization.table_vectorizer import TableVectorizer
