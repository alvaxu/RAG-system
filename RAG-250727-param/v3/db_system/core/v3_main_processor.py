...
# 添加v3目录到Python路径
import sys
v3_dir = Path(__file__).parent.parent.parent
sys.path.insert(0, str(v3_dir))

from config.config_manager import ConfigManager
from db_system.utils.document_type_detector import DocumentTypeDetector
...
from db_system.utils.mineru_integration import MinerUIntegration
