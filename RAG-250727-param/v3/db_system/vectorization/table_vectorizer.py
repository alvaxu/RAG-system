...
class TableVectorizer:
    ...
    def __init__(self, config_manager):
        ...
        # 初始化ModelCaller
        from db_system.core.model_caller import LangChainModelCaller as ModelCaller
    ...
    def vectorize_batch(self, tables: List[Dict]) -> List[Dict[str, Any]]:
        ...
        for i, table_item in enumerate(tables):
            try:
                # 获取表格内容
                table_content = table_item.get('table_content', '')  # 修改：使用 'table_content' 而不是 'table_body'
