...
# :function: PerceptionOutput
# :说明: 感知阶段输出的市场数据和信息结构体
# :字段:
#   - market_overview: 市场概况和最新动态
#   - key_indicators: 关键经济和市场指标
#   - recent_news: 近期重要新闻
...
# :function: ResearchAgentState
# :说明: 研究智能体的全局状态结构体，贯穿所有流程节点
# :字段:
#   - research_topic: 研究主题
#   - industry_focus: 行业焦点
...
#   - world_model: 内部世界模型
#   - reasoning_plans: 候选分析方案
#   - selected_plan: 选中的最优方案
#   - final_report: 最终研究报告
...
#     :function: router
#     :param state: 当前研究智能体状态（ResearchAgentState）
#     :return: 下一个流程阶段名称（str）
#     :说明: 路由函数，根据当前阶段和错误状态决定流程跳转。
#     """
...
def create_research_agent_workflow() -> StateGraph:
    """
    :function: create_research_agent_workflow
    :return: 编译后的StateGraph对象
    :说明: 构建并编译深思熟虑型研究智能体的流程状态图，定义各阶段节点及其转换。
    """
...
def run_research_agent(topic: str, industry: str, horizon: str) -> Dict[str, Any]:
    ...
    :param topic: 研究主题
    :param industry: 行业焦点
    :param horizon: 时间范围（短期/中期/长期）
    :return: 研究流程最终结果（包含报告、各阶段数据等）
    :说明: 运行完整的研究智能体流程，自动推进各阶段，输出最终研究报告。
    """
